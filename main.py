...
<body>
	...
	<h3 style="text-align: justify;font-size:12pt;">Verificamos e calculamos seu imc a partir das informações fornecidas no formulário:</h3>
	...
	<h3 style="text-align: justify; font-size:12pt;">De acordo com os resultados você está com o {imc[1]}, seu imc é {imc[0]}.</h3>
</body>
</html>
'''
